 ...
 *
 * Static mock data to get you started quickly.
 * Replace each section with your real API calls.
 *
 * Usage:
 *   import { SAMPLE_STATS, SAMPLE_ACTIVITIES, SAMPLE_QUICK_ACTIONS } from '../data/sampleData';
 */
